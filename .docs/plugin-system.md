...
Runtime emitters provide compile-time runtime generation.

Unlike compiler plugins, they generate platform-native runtime code from merged descriptors.
...
They should remain small, composable and independently tree-shakable.
